...
public class HtmlTreeBuilder extends TreeBuilder {
 ...
 @Override
    protected void initialiseParse(Reader input, String baseUri, ParseErrorList errors, ParseSettings settings, RBTree<myCpr<Integer, String>> KNNs, String[] rules) {
        super.initialiseParse(input, baseUri, errors, settings,KNNs, rules);
    ...
    private void insertNode(Node node) {
    	//moycode
    	node.offset = CMN.indexOffset;
    	//if(KNNs_!=null&&node.outerHtml()) {
    	//	KNNs_.insert(new myCpr(CMN.indexOffset,""));
    	//}
    	if(KNNs_!=null) {
    		////哈哈哈哈哈
    		//for(String iz:rules_)
	    	//if(CMN.rawHtml.startsWith(iz,CMN.indexOffset)) {
	    	//	KNNs_.insert(new myCpr(CMN.indexOffset,""));
	    	//}
    	}
    	//CMN.show("hhh"+CMN.indexOffset);
