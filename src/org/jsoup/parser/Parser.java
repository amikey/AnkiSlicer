...
public class Parser {
	...
	public static Document parse(String html, String baseUri, RBTree<myCpr<Integer, String>> KNNs, String[] prules) {
	        TreeBuilder treeBuilder = new HtmlTreeBuilder();
	        return treeBuilder.parse(new StringReader(html), baseUri, ParseErrorList.noTracking(), treeBuilder.defaultSettings(),KNNs, prules);
	    }
    /**
