...
public class ReadText {
    ...
    public static void speak(String text, String loc, int queueMode) {
        ...
        if (result == TextToSpeech.LANG_MISSING_DATA || result == TextToSpeech.LANG_NOT_SUPPORTED) {
            Toast.makeText(mReviewer.get(), "no_tts_available_message"
    ...
    public static void initializeTts(Context context) {
            ...
            public void onInit(int status) {
                if (status == TextToSpeech.SUCCESS) {
                    ...
                    if (availableTtsLocales.size() > 0) {
                        ...
                        Toast.makeText(mReviewer.get(), "no_tts_available_message", Toast.LENGTH_LONG).show();
        ...
        Toast.makeText(context, "initializing_tts", Toast.LENGTH_LONG).show();
    }
