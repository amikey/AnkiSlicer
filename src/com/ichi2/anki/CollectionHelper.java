...
public class CollectionHelper {
     ...
     * @throws Exception If no write access to directory
     */
    public static synchronized void initializeAnkiDroidDirectory(String path) throws Exception {
        // Create specified directory if it doesn't exit
        File dir = new File(path);
        if (!dir.exists() && !dir.mkdirs()) {
            throw new Exception("Failed to create AnkiDroid directory");
        }
        if (!dir.canWrite()) {
            throw new Exception("No write access to AnkiDroid directory");
        }
        ...
        if (!nomedia.exists()) {
            try {
                ...
                throw new Exception("Failed to create .nomedia file");
            }
        }
    }
