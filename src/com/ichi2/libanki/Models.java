...
public class Models {
     ...
     * @throws Exception */
    public void rem(JSONObject m) throws Exception {
        mCol.modSchema(true);
        try {
    ...
    public void setSortIdx(JSONObject m, int idx) throws Exception{
        try {
            mCol.modSchema(true);
            m.put("sortf", idx);
    ...
    public void addField(JSONObject m, JSONObject field) throws Exception {
    ...
    public void remField(JSONObject m, JSONObject field) throws Exception {
        mCol.modSchema(true);
        try {
            JSONArray ja = m.getJSONArray("flds");
    ...
    public void moveField(JSONObject m, JSONObject field, int idx) throws Exception {
        mCol.modSchema(true);
        try {
            JSONArray ja = m.getJSONArray("flds");
    ...
    public void renameField(JSONObject m, JSONObject field, String newName) throws Exception {
        mCol.modSchema(true);
        try {
     ...
     * @throws Exception */
    public void addTemplate(JSONObject m, JSONObject template) throws Exception {
        try {
            if (m.getLong("id") != 0) {
                mCol.modSchema(true);
            }
     ...
     * @throws Exception 
     */
    public boolean remTemplate(JSONObject m, JSONObject template) throws Exception {
        try {
     ...
     * @throws Exception 
     */
    public void change(JSONObject m, long[] nids, JSONObject newModel, Map<Integer, Integer> fmap, Map<Integer, Integer> cmap) throws Exception {
        mCol.modSchema(true);
        try {
    ...
    public static JSONObject addBasicModel(Collection col) throws Exception {
        return addBasicModel(col, "Basic");
    }


    public static JSONObject addBasicModel(Collection col, String name) throws Exception {
    ...
    public static JSONObject addForwardReverse(Collection col) throws Exception {
    ...
    public static JSONObject addForwardOptionalReverse(Collection col) throws Exception {
    ...
    public static JSONObject addClozeModel(Collection col) throws Exception {
        Models mm = col.getModels();
