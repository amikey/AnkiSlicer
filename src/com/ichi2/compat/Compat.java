...
public interface Compat {
    ...
    void restartActivityInvalidateBackstack(LauncherActivity activity);
    void setFullScreen(AbstractFlashcardViewer activity);
    void setSelectableBackground(View view);
    void openUrl(LauncherActivity activity, Uri uri);
    ...
    boolean isImmersiveSystemUiVisible(LauncherActivity activity);
